...
export function InteractiveReportCharts({ results, setupParams, cycleParams, marketParams }: InteractiveReportChartsProps) {
  ...
  const profitData = [
    { month: "Jan", profit: 2500, cost: 1800, revenue: 4300 },
    { month: "Fev", profit: 3200, cost: 1900, revenue: 5100 },
    { month: "Mar", profit: 2800, cost: 2000, revenue: 4800 },
    { month: "Abr", profit: 4100, cost: 2100, revenue: 6200 },
    { month: "Mai", profit: 3800, cost: 2200, revenue: 6000 },
    { month: "Jun", profit: 4500, cost: 2300, revenue: 6800 },
  ]

  const efficiencyData = [
    { metric: "g/W", value: results.gramas_por_watt, target: 1.0, status: "excellent" },
    { metric: "ROI %", value: results.roi_investimento_1_ano, target: 20, status: "good" },
    { metric: "Payback", value: results.periodo_payback_ciclos, target: 6, status: "warning" },
    { metric: "Eficiência", value: (results.gramas_por_watt * 100).toFixed(1), target: 100, status: "excellent" },
  ]

  const costBreakdown = [
    { category: "Iluminação", value: setupParams.custo_equip_iluminacao, percentage: 35 },
    { category: "Estrutura", value: setupParams.custo_tenda_estrutura, percentage: 25 },
    { category: "Ventilação", value: setupParams.custo_equip_iluminacao * 0.3, percentage: 20 },
    { category: "Controles", value: setupParams.custo_equip_iluminacao * 0.2, percentage: 15 },
    { category: "Outros", value: setupParams.custo_equip_iluminacao * 0.1, percentage: 5 },
  ]
