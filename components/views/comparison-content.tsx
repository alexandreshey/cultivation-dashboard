          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-green-600 dark:text-green-400">
                Lucro: {formatCurrency(bestScenario.results.lucro_liquido_ciclo)} | ROI:{" "}
                {bestScenario.results.roi_investimento_1_ano.toFixed(1)}%
              </p>
            </div>
          </div>
        </CardContent>
        ...
        <CardContent>
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody>
                <tr className="border-b">
                  <td className="p-2 font-medium">Lucro por Ciclo</td>
                  {scenarios.map((scenario) => (
